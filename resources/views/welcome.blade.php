...
<head>
    ...
    <style>
        ...
        .btn-custom {
            background-color: rgb(110, 79, 16);
            color: white;
    ...
    <div class="container-fluid header" style="position: relative; z-index: 1;">
        <div class="row align-items-center container-fluid">
            ...
            <div class="col-md-4 ms-auto text-md-end mt-3">
                <a href="{{ route('login') }}" class="btn btn-custom btn-sm">Entrar com seu perfil</a>
                <div class="dropdown d-inline">
                    <button class="btn btn-custom btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown">
                        Cadastre-se
                    </button>
